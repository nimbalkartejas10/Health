		...
		<div class="jumbotron w-100 mb-0 p-0 jb jb-mn">
			<div class="card w-100">
			  ...
			  <div class="card-img-overlay">
				...
				echo '
			    <a href="Health.php" class="btn btn-info btn-lg pl-4 pr-4">Try Now</a><br><span style="letter-spacing: .1em;">Its Free</span>
				';}
				else{echo'
			    <a href="login.php" class="btn btn-info btn-lg pl-4 pr-4">Try Now</a><br><span style="letter-spacing: .1em;">Its Free</span>';}
				?>
			  </div>
			</div>
		</div>
